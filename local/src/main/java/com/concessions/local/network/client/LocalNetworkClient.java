...
public class LocalNetworkClient {
	...
	public void start() throws IOException {
		...
		logger.info("LocalNetworkClient bound successfully on {}:{}", serverIp, tcpServerPort);

		// Start the TCP Listener thread to accept client connections
		Thread tcpListenerThread = new Thread(this::startTcpListener, "LocalNetworkClient-TCP-Listener");
		tcpListenerThread.start();

		logger.info("LocalNetworkClient is active. IP Address: {}, TCP Port: {}", serverIp,
				tcpServerPort);
	}
	...
	public static void main(String[] args) {
		LocalNetworkClient manager = new LocalNetworkClient();
		try {
			manager.start();
